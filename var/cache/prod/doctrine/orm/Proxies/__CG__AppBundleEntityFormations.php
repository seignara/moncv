 ...
 */
class Formations extends \AppBundle\Entity\Formations implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Formations' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Formations' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Formations' . "\0" . 'dateDebut', '' . "\0" . 'AppBundle\\Entity\\Formations' . "\0" . 'dateFin', '' . "\0" . 'AppBundle\\Entity\\Formations' . "\0" . 'lieu'];
        }
